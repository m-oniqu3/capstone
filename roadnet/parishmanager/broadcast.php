    ...
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link text-primary" href="http://localhost/roadnet/parishmanager/broadcast.php">Broadcast Message<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
        ...
        <?php
            ...
            if (isset($_POST['saveBtn'])) {
                ...
                $iquery = "INSERT INTO pmannouncement(receiver, aDate, aMessage, aTitle, username) values ('".$recp."', '".$date."', '".$message."', '".$title."', '".$ename."')";
                ...
                echo '</h3>';
                header("refresh:4; http://localhost/roadnet/parishmanager/broadcast.php");
