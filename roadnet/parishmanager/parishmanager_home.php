...
<html lang="en">
    <head>
        ...
        <title>Parish Manager Home</title>
    ...
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link text-primary" href="http://localhost/roadnet/parishmanager/parishmanager_home.php">Home<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="d-flex justify-content-center">
            <div class="col-sm-2 btn-group-vertical">
                ...
                <a href="#"><button type="button" class="btn btn-info btn-lg">View Report</button></a>
                <br><br>

                <a href="#"><button type="button" class="btn btn-info btn-lg">Prioritize Reports</button></a>
                <br><br>

                <a href="#"><button type="button" class="btn btn-info btn-lg">Generate Reports</button></a>
                <br><br>

                <a href="#"><button type="button" class="btn btn-info btn-lg">Broadcast Message</button></a>
                <br><br>
