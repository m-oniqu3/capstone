...
<html lang="en">
    <head>
        ...
        <title>Director View Report</title>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link text-primary" href="http://localhost/roadnet/director/viewReport.php">View Report<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
        ...
        <?php 
            ...
            if (isset($_POST['searchRep'])) {
                ...
                <table id="report_data" class="table table-striped table-bordered">
                    ...
                    $query = "SELECT reportID, firstname, lastname, telephone, parish, town, gpscoord, address, direction, incident, description, media, vstatus, rdate, priority FROM report WHERE (parish = '$parish') ORDER BY reportID ASC";
