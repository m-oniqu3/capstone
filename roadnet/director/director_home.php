    ...
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link text-primary" href="http://localhost/roadnet/director/director_home.php">Home<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="d-flex justify-content-center">
            <div class="col-sm-2 btn-group-vertical">
                ...
                <a href="http://localhost/roadnet/director/viewReport.php"><button type="button" class="btn btn-info btn-lg">View Reports</button></a>
                <br><br>
