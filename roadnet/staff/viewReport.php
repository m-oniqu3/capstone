...
<html lang="en">
    ...
    <body>
        ...
        <!--<div class="container">-->
            <br>
            <h1 class="ml-3"> Incident Reports for the Parish of <?php echo $presult["parish"] ?></h1>
                <table id="report_data" class="table text-center table-striped table-bordered">
                    <thead>
                        <tr>
                            <td>Report ID</td>
                            <td>First Name</td>
                    ...
                    <?php
                        ...
                        if ($countVal >= 1) {
                            $query = "SELECT reportID, firstname, lastname, telephone, parish, town, gpscoord, address, direction, incident, description, media, vstatus, rdate, priority, assignedTo FROM report WHERE (parish = '".$presult["parish"]."') ORDER BY reportID DESC";
                            ...
                            while($row = mysqli_fetch_array($result)) {
                                ...
                                <tr>
                                    ...
                                    echo '<td>';
                                    echo '<a href="?id=' . $row['reportID'] . '" class=" d-inline btn btn-success" >View</a>';
                                    echo '<a href="?id=' . $row['reportID'] . '" class=" d-inline ml-1  btn btn-info" >Update</a>';
                                   echo '<a href="assign.php?id=' . $row['reportID'] . '" class=" d-inline ml-1 btn btn-warning" >Assign</a>';
                                    echo "</td>";
                                echo '</tr>
                                ';
                            }
