...
<html lang="en">
    <head>
        ...
        <title>Staff Send Message</title>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link text-primary" href="http://localhost/roadnet/staff/sendMessage.php">Message<span class="sr-only">(current)</span></a>
                    </li>
                </ul>
        ...
        <?php
            ...
            if(isset($_POST['submit'])) {
                ...
                if ($countVal == 1) {
                    ...
                    echo '</h2>';
                    header("refresh:3; http://localhost/roadnet/staff/sendMessage.php");
                }
                elseif ($countVal1 < 1) {
