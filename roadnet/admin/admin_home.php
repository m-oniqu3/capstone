    ...
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link text-primary" href="http://localhost/roadnet/admin/admin_home.php">Home<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="http://localhost/roadnet/admin/crud.php">View & Modify Users</a>
                    </li>
                </ul>
        ...
        <div class="d-flex justify-content-center">
            <div class="col-sm-2 btn-group-vertical">
                <a href="http://localhost/roadnet/admin/createusr/createuser.php"><button type="button" class="btn btn-info btn-lg">Create User</button></a>

                <br>
                <br>
                <br>

                <a href="http://localhost/roadnet/admin/crud.php"><button type="button" class="btn btn-info btn-lg">View Users</button></a>

                <br>
                <br>
                <br>

                <a href="http://localhost/roadnet/admin/crud.php"><button type="button" class="btn btn-info btn-lg">Update Users</button></a>

                <br>
                <br>
                <br>

                <a href="http://localhost/roadnet/admin/crud.php"><button type="button" class="btn btn-info btn-lg">Delete Users</button></a>
