...
<html lang="en">
    <head>
        ...
        <title>Contractor View Report</title>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link text-primary" href="http://localhost/roadnet/contractor/viewReport.php">View Report<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
            ...
            <h1>View Report</h1>
                <table id="report_data" class="table table-striped table-bordered">
                    ...
                    <?php
                        ...
                        if ($countVal >= 1) {
                            $query = "SELECT reportID, firstname, lastname, telephone, parish, town, gpscoord, address, direction, incident, description, media, vstatus, rdate FROM report WHERE (parish = '".$presult["parish"]."') ORDER BY reportID DESC";
