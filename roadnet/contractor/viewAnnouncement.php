...
<html lang="en">
    <head>
        ...
        <title>Contractor View Announcement</title>
    ...
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link text-primary" href="http://localhost/roadnet/contractor/viewAnnouncement.php">Announcement<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container">
            ...
            <?php
                ...
                $aquery = "SELECT aDate, aMessage, aTitle, username FROM pmAnnouncement WHERE (username = '".$uname["username"]."' AND receiver = 'Contractor' OR receiver = 'All') ORDER BY announcementID DESC";
        ...
        <div class="container">
            ...
            <?php
                ...
                $aquery = "SELECT aDate, aMessage, aTitle, username FROM drAnnouncement WHERE (receiver = 'Contractor' OR receiver = 'All') ORDER BY announcementID DESC";
                $aresult = mysqli_query($connect, $aquery);
                while ($row = $aresult->fetch_assoc()) {
                    echo '
                    <tr>
